<?php
	class User extends Controller
	{
		...
		function filtrar_por_nombre_y_descripcion(){
			   if(isset($_POST["string"])){
			   	     //header('Content-type: application/json');
                     $res=json_encode($this->model->filtrar_por_nombre_y_descripcion($_POST["string"]));
			   	    // echo $this->model->filtrar_por_nombre_y_descripcion($_POST["stringABuscar"]);
                     ...
                     ?><script>document.location="<?php echo URL; ?>"</script><?php 
			   	    ...
			   	    ?><script>alert("dato nulo");document.location="<?php echo URL; ?>"</script><?php
			   }
